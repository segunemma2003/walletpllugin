    ...
    <AnimatePresence>
      {notification && (
        <motion.div
          ...
          className={`fixed top-0 left-0 right-0 z-50 p-4 border-b ${getBackgroundColor(notification.type)}`}
        >
          <div className="max-w-md mx-auto flex items-start space-x-3">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={onClose}
              className={`p-1 rounded-lg transition-colors ${getTextColor(notification.type)} opacity-70 hover:opacity-100`}
            >
              <X className="w-4 h-4" />
            </motion.button>
          </div>
